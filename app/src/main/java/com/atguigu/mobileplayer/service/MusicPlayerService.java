package com.atguigu.mobileplayer.service;
...
import com.atguigu.mobileplayer.activity.AudioPlayerActivity;
...
public class MusicPlayerService extends Service {
    ...
    public void openAudio(int position){
        ...
        if (mediaItems!=null&&mediaItems.size()>0){
            ...
            if (mediaPlayer!=null){
                //有这一行的时候，播放一首歌的时候再去点开一首歌就播放不了
                //mediaPlayer.release();//如果不为空，先把之前的释放掉
                mediaPlayer.reset();
            }
           ...
           try {
               ...
               mediaPlayer.prepareAsync();//准备完成，异步的。
   ...
   private NotificationManager manager;
    ...
    private void start(){
        ...
        //参数，1.上下文，2，请求码，3.意图，4.flag
        PendingIntent pendingIntent = PendingIntent.getActivity(this,0,intent,0);
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            String channelId = "music";
            String channelName = "通知栏消息";
